...
import { useGetMachineLearningQuery } from "@/redux/feature/courses/courseApi";
...
const machineLearningModule = [
  {
    number: 1,
    title: "Intro to Data Science & Python Foundations",
    topics: [
      {
        content: "Basics of AL, ML< CV & Industry Applications",
      },
      {
        content: "Python crash cource (NumPy, Pandas, Matplotlib, Seaborn)",
      },
      {
        content: "Homework: Python data manipulation & visualization",
      },
    ],
  },
  {
    number: 2,
    title: "Data Wrangling & EDA (Exploratory Data Analysis)",
    topics: [
      {
        content:
          "Cleaning messy data (missing values, outliers, categorical encoding).",
      },
      {
        content: "Data visualization & storytelling with Seaborn/Matplotlib.",
      },
      {
        content: "Saturday Project: Analyze a real datataset (Kaggle/CSV).",
      },
    ],
  },
  {
    ...
    topics: [
      {
        content: "Descriptive & Inferential statistics",
      },
      {
        content: "Probability distributions & hypothesis testing",
      },
      {
        content: "Project: Customer churn EDA & hypothesis testing",
      },
    ],
  },
  {
    ...
    topics: [
      ...
      {
        content:
          "Regression & Classification (Linear Regression, Logistic Regression, kNN)",
      },
      {
        content: "Assignment: Build ML models on real datasets",
      },
    ],
  },
  {
    ...
    topics: [
      ...
      {
        content: "Model evaluation (accuracy, precision, recall, F1, ROC)",
      },
      {
        content: "Project: Fraud detection using ML models",
      },
    ],
  },
  {
    number: 6,
    title: "Feature Engineering & Model Deployment Basics",
    topics: [
      {
        content: "Feature scaling, selection & dimensionality reduction (PCA)",
      },
      {
        content:
          "Train-test splits, cross-validation, hyperparameter tuning (Grid/Random Search)",
      },
      {
        content: "Project: Deploy a trained ML model with Flask/FastAPI",
      },
    ],
  },
  {
    ...
    topics: [
      {
        content: "Perceptrons, Activation Functions, Backpropagation",
      },
      {
        content: "TensorFlow & PyTorch intro",
      },
      {
        content:
          "Project: Build your first neural network for MNIST digit classification",
      },
    ],
  },
  {
    ...
    topics: [
      {
        content: "CNNs (Convolutional Neural Networks) for images",
      },
      {
        content: "RNNs/LSTMs for sequences (time-series, NLP basics)",
      },
      {
        content: "Project: Sentiment Analysis or Image Classification",
      },
    ],
  },
  {
    ...
    topics: [
      {
        content: "Transfer Learning (ResNet, VGG, Inception)",
      },
      {
        content: "Fine-tuning & data augmentation",
      },
      {
        content: "Project: Image classification using transfer learning",
      },
    ],
  },
  {
    ...
    topics: [
      ...
      {
        content: "Image Segmentation (U-Net, Mask R-CNN)",
      },
      {
        content:
          "Project: Build a face mask detector or vehicle detection system",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    topics: [
      {
        content:
          "Capstone Project: Choose one (Healthcare AI, Finance AI, CV app, NLP app)",
      },
      {
        content: "Resume building, interview preparation, portfolio on GitHub",
      },
      {
        content: "Certifications & career roadmap in Data Science & AI",
      },
    ],
  },
];
...
export default function Page() {
  ...
  const { data, isFetching, isLoading } = useGetMachineLearningQuery();
  ...
  const handleStartLearning = () => {
    router.push("/payment?course=Machine%20Learning");
  };
          ...
          <div className="relative flex flex-col justify-center items-center h-full text-center">
            ...
            <div className="px-4">
              ...
              <p className="text-white opacity-80 mt-6 max-w-3xl lg:text-lg mx-auto">
                Our Machine Learning course takes you from the foundations to
                advanced applications, teaching you how to build intelligent
                systems that learn from data. Through practical projects and
                real-world case studies, you’ll master core algorithms, model
