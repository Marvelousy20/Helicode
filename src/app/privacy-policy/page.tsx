  ...
  return (
    <section className="lg:pt-24 pt-10 w-full">
      <div className="flex flex-col gap-12">
        ...
        <h1 className="text-lg lg:text-2xl leading-10 font-medium uppercase">
        ...
        <div className="w-full">
          ...
          <ol className=" list-disc list-outside flex flex-col gap-2 pl-3">
            ...
            <li>
              ...
              computer, a cellphone or a digital table
            </li>
            <li>
            ...
            <li>
              Website refers to Helicode, accessible from
              https://www.helicode.xyz/
            </li>
          </ol>
          <p className=" pt-4 font-normal text-base lg:w-[1136px] w-full">
        ...
        <div className="w-full">
          ...
          <div className=" pt-4 font-normal text-base lg:w-[1136px] w-full">
            ...
            <ol className=" list-disc list-outside flex flex-col gap-2 pl-3">
              <li className="">Cookies Policy / Notice Acceptance Cookies</li>
            ...
            <ol className=" list-disc list-outside flex flex-col gap-2 pl-3">
              <li className="">Functionality Cookies</li>
              <p>Type: Persistent Cookies</p>
              <p>Administered by: Us</p>
              <p>
        ...
        <div className="flex flex-col gap-4">
          ...
          <ol className=" list-disc list-outside flex flex-col gap-2 pl-3">
            ...
            <li>
              Protect the personal safety of Users of the Service or the publi
            </li>
