...
const courses = [
  {
    heading: "Decentralized App (DApp) Design Principles",
  ...
  {
    heading: "Blockchain-Specific UX Patterns",
  ...
  {
    heading: "Wallet Integration and Management Interfaces",
    text: "Master Human-Centered Design principles, Design Thinking, and User Research to create intuitive and user-friendly products that address real user needs.",
  },
  {
    heading: "Token-Gated Experiences",
  ...
  {
    heading: "NFT Showcase and Marketplace Design",
    text: "Master Human-Centered Design principles, Design Thinking, and User Research to create intuitive and user-friendly products that address real user needs.",
  },
  {
    heading: "Web3 Design Tools and Frameworks",
    text: "Master Human-Centered Design principles, Design Thinking, and User Research to create intuitive and user-friendly products that address real user needs.",
  },
];
        ...
        >
          <div className="relative flex flex-col justify-center items-center h-full text-center">
            <div className="flex items-center border border[#9960FF]/[20] border-[#99A9FF3D] py-[6px] px-3 rounded-full">
              ...
              <h3 className="text-xs lg:text-base">School of Design</h3>
            </div>
            <div className="px-4">
