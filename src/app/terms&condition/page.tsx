    ...
    <section className="lg:pt-24 pt-10 w-full">
      <div className="flex flex-col gap-12">
        ...
        <div className="w-full">
          ...
          <div className=" pt-4 font-normal text-base lg:w-[1136px] w-full">
            ...
            <p className="">
              ...
              time. All payments shall be in US dollars. You agree to pay all
        ...
        <div className="w-full">
          ...
          <div className=" pt-4 font-normal text-base lg:w-[1136px] w-full">
            <h3 className="text-base lg:text-lg leading-10 font-medium">
              Billing and Renewal
            </h3>
            <p className="">
