...
const courses = [
  {
    heading: "Foundations of Cryptography and Privacy",
    text: "Master Human-Centered Design principles, Design Thinking, and User Research to create intuitive, user-friendly products that address real user needs.",
  },
  {
    heading: "ZKP Protocols: From zk-SNARKs to zk-STARKs",
  ...
  {
    heading: "Implementing ZKPs in Smart Contracts",
  ...
  {
    heading: "Privacy-Enhancing Technologies in Blockchain",
  ...
  {
    heading: "ZKP Applications in Finance, Identity, and Beyond",
    text: "Master Human-Centered Design principles, Design Thinking, and User Research to create intuitive and user-friendly products that address real user needs.",
  },
  {
    heading: "Scalability Solutions and Layer 2 Innovations",
    text: "Master Human-Centered Design principles, Design Thinking, and User Research to create intuitive and user-friendly products that address real user needs.",
  },
];
