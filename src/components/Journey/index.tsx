        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8 lg:mt-16 text-start">
          ...
          <div className="border border-[#232323] bg-[#080821] px-5 py-6 lg:p-9 rounded-[10px]">
            ...
            <p className="mt-6 text-[#828B9C]">
              ...
              Data Analysis, Cybersecurity, Technical Writing and so much more!
            </p>
          </div>
          ...
          <div className="border border-[#232323] bg-[#080821] px-5 py-6 lg:p-9 rounded-[10px]">
            ...
            <p className="mt-6 text-[#828B9C]">
              Join a community of like-minded Web3 enthusiasts. Get ideas from a
              global network of Web3 experts.
            </p>
          </div>
