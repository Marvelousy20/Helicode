...
const Journey = () => {
  return (
    <section className="lg:pt-[7.5rem]">
      <div className="max-w-[62rem] mx-auto text-center">
        <div className="">
          <h1 className="font-extrabold lg:text-[3rem]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8 lg:mt-16 text-start">
          <div className="border border-dashed border-[#5D5D5D] lg:p-9">
            ...
            <h3 className="mt-10 font-bold text-xl">Advance Your Knowledge</h3>
            <p className="mt-6">
          ...
          <div className="border border-dashed border-[#5D5D5D] lg:p-9">
            ...
            <h3 className="mt-10 font-bold text-xl">Test Your Abilities</h3>
            <p className="mt-6">
          ...
          <div className="border border-dashed border-[#5D5D5D] lg:p-9">
            ...
            <h3 className="mt-10 font-bold text-xl">Complete Quests</h3>
            <p className="mt-6">
          ...
          <div className="border border-dashed border-[#5D5D5D] lg:p-9">
            ...
            <h3 className="mt-10 font-bold text-xl">Earn Badges/Rewards</h3>
            <p className="mt-6">
              Assess your skills and knowledge with our comprehensive tests
              designed to challenge and enhance your abilities.
            </p>
