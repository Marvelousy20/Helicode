...
//                 </button>
//                 {/* {showCourses && (
//                   <div className="absolute z-50 left-0 mt-2 w48 min-w-max rounded-md shadow-lg bg-[#0A081B] bg[#2C2C2C] border border-[#3B00BA33] ring-1 ring-black ring-opacity-5">
//                     <div
//                       className="py-1"
//                       role="menu"
...
//                           key={course.id}
//                           href={`/${course.path}`}
//                           className="block px-4 py2 py-4 text-base text-white hover:bg-slate-900"
//                           role="menuitem"
//                           onClick={(e) => {
//                             e.preventDefault();
//                             handleCourseLinkClick(`/${course.path}`);
//                           }}
//                         >
//                           {course.name}
//                         </Link>
...
//           {isOpen && (
//             <div className="block md:hidden z-20 absolute top top-full w-full bg-black text-white p-4 right-0 left-0 text-start">
//               <div className="flex flex-col gap-12">
//                 <div className="px-2 pt-2 pb-3 space-y1 sm:px-3 flex-grow flex flex-col justify-center space-y-4">
//                   <Link
//                     href="/"
...
//     <div className="block md:hidden z-20 absolute top top-full w-full bg-black text-white p-4 right-0 left-0 text-start">
//       <div className="flex flex-col gap-12">
//         <div className="flex-grow flex flex-col justify-center space-y-4 text-center">
//           <Link
//             href="/"
//             className="block hover:bg-slate-900 px-3 py-2 rounded-md text-lg"
//             onClick={() => setIsOpen(false)}
//           >
//             Home
//           </Link>
//           <button
//             className="w-full text-center hover:bg-slate-950 px-3 py-2 rounded-md text-lg"
//             onClick={() => setShowCourses(!showCourses)}
//           >
//             Explore Courses
//           </button>
...
//                   key={course.id}
//                   href={`/${course.path}`}
//                   className="block hover:bg-gray-700 px-3 py-2 rounded-md text-left"
...
// {
//   isOpen && (
//     <div className="fixed inset-0 z-50 bg-gray800 bg-[#0A081B] md:hidden">
//       <div className="px-5 pt2 pt-5 pb-3 h-full flex flex-col">
...
//           </Link>
//           <button
//             className="w-full text-left hover:bg-slate-900 px-3 py-2 rounded-md text-lg"
//             onClick={() => setShowCourses(!showCourses)}
//           >
//             Explore Courses
//           </button>
...
//                   key={course.id}
//                   href={`/${course.path}`}
//                   className="block hover:bg-gray-700 px-3 py-2 rounded-md text-center"
//                   onClick={handleCourseLinkClick}
//                 >
//                   {course.name}
//                 </Link>
